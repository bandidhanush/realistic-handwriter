...
#            print("Thread terminated")
    ...
    def popup_keyerror(self, foreign_char):
        ...
        error_popup.setText('The character ' + foreign_char + ' has not been fed into this version of HandWriter. Add the character in the Repo')
